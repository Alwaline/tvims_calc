...
"")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(150, 120, 215, 116))
        ...
        self.lable_8 = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lable_8.setObjectName("lable_8")
        self.horizontalLayout_3.addWidget(self.lable_8)
        self.n = QtWidgets.QLineEdit(parent=self.layoutWidget)
        self.n.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhNone)
    ...
    def retranslateUi(self, Form):
        ...
        self.lable_8.setText(_translate("Form", "<html><head/><body><p>n:</p></body></html>"))
