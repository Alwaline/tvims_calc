...
from interface.py.cm_wo_rep import Ui_Form
from interface.forms.Child import ChildForm

from service.calc import cm_wo_rep

class CmWoRepForm(ChildForm, Ui_Form):
    def __init__(self, parent=None):
        super().__init__(parent)

        self.formula.setPixmap(QPixmap("interface/images/5.png"))
